        ...
        <div class="container">
            <div class="row">
                <div class="page-head-content">
                    <h1 class="page-title">{{$museum->getTranslatedAttribute('name')}}</h1>
                </div>
            </div>
        </div>
    </div>
<!--Slide-->
                ...
                <div class="sheetSlider sh--default" style="background-color: #929292;">
                    ...
                    <div class="sh__content">
                        ...
                        <div class="mycol-container">
                            <div class="mycol1">
                                <img src="{{ asset('images/muzee_geo/tsunami/1.jpg') }}" />
                            </div>
                        ...
                        <div class="sh__item">
                            <div class="mycol-container">
                                <div class="mycol1">
                                    <img src="{{ asset('images/muzee_geo/tsunami/2.jpg') }}" />
                                </div>
                                <div class="mycol2" style="background-color: #929292;">
                                    <h2>Sea Waves</h2>
                        ...
                        <div class="sh__item">
                            <div class="mycol-container">
                                <div class="mycol1">
                                    <img src="{{ asset('images/muzee_geo/tsunami/3.jpg') }}" />
                                </div>
                                <div class="mycol2" style="background-color: #929292;">
                        ...
                        <div class="sh__item">
                            <div class="mycol-container">
                                <div class="mycol1">
                                    <img src="{{ asset('images/muzee_geo/tsunami/4.jpg') }}" />
                                </div>
                                <div class="mycol2" style="background-color: #929292;">
                                    <h2>Public Park</h2>
                        ...
                        <div class="sh__item">
                            <div class="mycol-container">
                                <div class="mycol1">
                                    <img src="{{ asset('images/muzee_geo/tsunami/5.jpg') }}" />
                                </div>
                                <div class="mycol2" style="background-color: #929292;">
    ...
    <div class="content-area blog-page padding-top-40" style="background-color: #f5f5fa; padding-bottom: 55px;">
        <div class="container">
            {!!$museum->getTranslatedAttribute('desc')!!}
        </div>
